package fr.undercraft.mcneo.objects.blocks.azalea;
...
public class AzaleaLeaves extends Block {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        fastIcon = iconRegister.registerIcon(Main.MODID + ":azalea_leaves" + "_opaque");
        blockIcon = iconRegister.registerIcon(Main.MODID + ":azalea_leaves");
    }
